...
// DEFINITION_COMPARE_STUDENT(Name)
// DEFINITION_COMPARE_STUDENT(Average)

// void StudentManager::sortStudent(CompareFunc compareFunc)
// {
//     studentDatabase.sort(compareFunc);
// }
